                    ...
                    <div className="col-md-8">
                        <div className="post-box">
                            <div className="post-meta">
                                ...
                                <ul>
                                    <li>
                                        <i className="fa fa-tags" aria-hidden="true"></i> <label>{blog.category?.name || 'Uncategorized'}</label>
                                    </li>
                                </ul>
                                <p className='mt-3'><strong><i>{blog.summary}</i></strong></p>
                            </div>
                            {blog.description ? (
                                <div className="article-content" dangerouslySetInnerHTML={{ __html: fixedDescription }}></div>
                            ) : (
